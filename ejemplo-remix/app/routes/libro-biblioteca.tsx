...
export default function Index() {
    ...
    const [sortFieldSeleccionado, setSortFieldSeleccionado] = useState({
        sortField: data.findDto ? data.findDto.sortField : '',
        sortOrder: data.findDto ? data.findDto.sortOrder : '',
        sortFieldLabel: data.findDto ? data.findDto.sortField : ''
    ...
    const navegarParametros = () => {
        navigate(`${path}` + generarNavegarParametros());
    };
    const generarNavegarParametros = () => {
        const skipTakeLocal = {
            skip: 0,
            take: 0,
        }
        ...
        <KonstaContainer titulo="Libro biblioteca">
            <Page>
                ...
                <Fab
                    ...
                    onClick={() => {
                        navigate(`${path}/new` + generarNavegarParametros())
                    }}
                    text="+"/>
                <Outlet/>
            </Page>
